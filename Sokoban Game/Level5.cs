...
namespace Sokoban_Game
{
    public partial class Level5 : Form
    {
        ...
        private void Init()
        {
            ...
            ar[4, 3].istarget = true;
            ar[8, 6].istarget = true;
            ar[1, 8].istarget = true;
            ar[8, 1].istarget = true;
            ...
            boxA = new Crate(2, 7, ar);
            boxB = new Crate(5, 4, ar);
            boxC = new Crate(1, 4, ar);
            boxD = new Crate(4, 6, ar);
        ...
        public void Draw()
        {
            ...
            foreach (Wall c in ar)
            {
                ...
                else
                {
                    ...
                    if (c.istarget)
                        panel1.BackColor = System.Drawing.Color.MediumSeaGreen;

                    if (c.iswall)
                        panel1.BackColor = System.Drawing.Color.FromArgb(0, 64, 64);
